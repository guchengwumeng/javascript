...
var figure = document.getElementById("figure"); //头部圆内数字节点
var reveal = document.getElementById("reveal"); // 图1节点
var hide = document.getElementById("hide"); //图2节点   
var role = document.getElementById("role"); // 角色节点 
var identity = document.getElementById("identity"); //按钮节点
